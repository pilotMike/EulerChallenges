...
namespace EulerTools.Numbers
{
    public class Pandigital
    {
        ...
        private const int MaxDigitLength = 9;

        /// <summary>
        /// Returns whether the combined multiplicand, multiplier and product
        /// contain 1-9 exactly once and is 9 digits long.
        /// </summary>
        ...
        public bool IsPandigital(int multiplicand, int multiplier, int product)
        {
            ...
            if (prospective.Length != MaxDigitLength) return false;
        ...
        {
            string prospective = number.ToString();
            if (prospective.Length != MaxDigitLength) return false;
            var containsAll = !Digits.Except(prospective).Any();
            return containsAll;
        }
